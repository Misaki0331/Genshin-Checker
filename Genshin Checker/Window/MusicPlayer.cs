...
namespace Genshin_Checker.Window
{
    public partial class MusicPlayer : Form
    {
        public MusicPlayer()
        {
            ...
            update.Start();
            ButtonStop.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.stop_button, ButtonStop.Width, ButtonStop.Height);
            ButtonNext.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.next_track_button, ButtonNext.Width, ButtonNext.Height);
        ...
        private void update_Tick(object sender, EventArgs e)
        {
            ...
            if (Player.Instance.IsPlaying)
            {
                if (ButtonPlay.Name != "Pause")
                {
                    ...
                    ButtonPlay.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.pause_button, ButtonPlay.Width, ButtonPlay.Height);
                }
            }
            else
            {
                if (ButtonPlay.Name != "Play")
                {
                    ...
                    ButtonPlay.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.play_button, ButtonPlay.Width, ButtonPlay.Height);
                }
            }
        }
        ...
        private void SetCurrentLoopButton()
        {
            ...
            {
                case Player.LoopMode.Normal:
                    ButtonLoop.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.right_arrow, ButtonLoop.Width, ButtonLoop.Height);
                    break;
                case Player.LoopMode.Repeat:
                    ButtonLoop.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.repeat_button, ButtonLoop.Width, ButtonLoop.Height);
                    break;
                case Player.LoopMode.SingleRepeat:
                    ButtonLoop.Image = Core.General.UI.DrawControl.BitmapInterpolation(resource.fluentui_emoji.repeat_single_button, ButtonLoop.Width, ButtonLoop.Height);
                    break;
            }
        }
