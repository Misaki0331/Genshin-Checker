...
namespace Genshin_Checker.Model.HoYoLab.StellarJourney {
    ...
    public class AvatarInfo
    {
        ...
        public List<ChangedAvatarList> changed_avatar_list { get; set; }
    ...
    {
        public List<object> honor_avatar_list { get; set; }
    ...
    public class CostumeInfo
    {
        ...
        public List<object> costume_list { get; set; }
        public bool has_data { get; set; }
    }
    ...
    public class Data
    {
        ...
        public CostumeInfo costume_info { get; set; }
        public ExplorationInfo exploration_info { get; set; }
        public ResourceInfo resource_info { get; set; }
        public HistoryStatInfo history_stat_info { get; set; }
        public List<SpiralAbyssInfo> spiral_abyss_info { get; set; }
    ...
    {
        public List<WorldExplorationList> world_exploration_list { get; set; }
        public List<CrystalList> crystal_list { get; set; }
        public List<ChestList> chest_list { get; set; }
        public TransPoint trans_point { get; set; }
        public DungeonPoint dungeon_point { get; set; }
        public bool has_data { get; set; }
    }

    public class GcgInfo
    {
        public List<object> avatar_card_list { get; set; }
        public int cur_avatar_card_num { get; set; }
        public int new_avatar_card_num { get; set; }
        public List<object> action_card_list { get; set; }
        public int cur_action_card_num { get; set; }
        public int new_action_card_num { get; set; }
        public List<ChallengeList> challenge_list { get; set; }
        public bool has_data { get; set; }
    }
    ...
    public class HistoryStatInfo
    {
        ...
        public List<AchievementList> achievement_list { get; set; }
        public string mostly_visit_dungeon_name { get; set; }
        public int mostly_visit_dungeon_times { get; set; }
        public string mostly_visit_weekly_boss_name { get; set; }
    ...
    public class ResourceInfo
    {
        ...
        public List<HcoinSourceList> hcoin_source_list { get; set; }
        public int consume_resin { get; set; }
        public List<ResinConsumeList> resin_consume_list { get; set; }
        public bool has_data { get; set; }
    }
    ...
    public class SpiralAbyssInfo
    {
        ...
        public List<RevealRank> reveal_rank { get; set; }
        public List<DamageRank> damage_rank { get; set; }
        public List<DefeatRank> defeat_rank { get; set; }
        public List<TakeDamageRank> take_damage_rank { get; set; }
        public int total_star { get; set; }
        public string name { get; set; }
        public List<NormalSkillRank> normal_skill_rank { get; set; }
        public List<EnergySkillRank> energy_skill_rank { get; set; }
    }
    ...
    public class WeaponInfo
    {
        ...
        public List<ChangedWeaponList> changed_weapon_list { get; set; }
        public bool has_data { get; set; }
    }
